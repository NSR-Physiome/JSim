c File lsodes.f (Version 1.2).  Last modified at 13:52:37 on 8/31/98.
c
c Added two work arrays, ipar and rpar, for the
c subroutine for right-hand side vector f so that it looks
c similar to that in radau and dopri5.
c
c Modified: (Aug, 98) Zheng Li
c
c
...
c ** error -- illegal path specified
 111  flag = 11*n + 1
     ...
     1                     wk, iwk, ipper, f, jac, ipar, rpar)
clll. optimize
      external f,jac
...
c
     ...
     1   wm, iwm, f, jac, pjac, slvs, ipar, rpar)
clll. optimize
