...
public class ColumnDataFormat extends DataFormat {
	...
	public String shortName() { return "column"; }
	...
	public DataReader createReader(Reader rdr) throws Xcept {
	    return new ColumnDataReader(this, rdr);
	}

	// write support
	public DataWriter createWriter() {
	    return new ColumnDataWriter(this);
	}
}
