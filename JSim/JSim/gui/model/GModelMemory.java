...
public class GModelMemory extends GNode {
	...
	private JLabel l_config1, l_config2;

	private GVertTable g_tbl;
	...
	public void makeContent() {
	    ...
	    panel.add(l_N);
	    l_config1 = new JLabel(
	    	"To show details of configuring JSim memory"
		+ " in your browser,", JLabel.CENTER);
	    l_config2 = new JLabel(
		"select 'JSim Memory Usage...'"
		+ " from the Help menu.", JLabel.CENTER); 
            panel.add(l_config1);
            panel.add(l_config2);
	...
	public void reconfig() {
	    ...
	    // position storeGrids select
 	    centerJComp(l_data, wleft/2, wmid, y);
	    ...
	    y += sp*10;
	    centerJComp(l_config1, 0, w, y);
	    y += sp*3;
	    centerJComp(l_config2, 0, w, y);
	}
