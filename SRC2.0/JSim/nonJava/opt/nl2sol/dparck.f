...
C
      ...
      IF (ALG .EQ. IV(ALGSAV)) GO TO 20
         IF (PU .GT. 0) WRITE(PU,10) ALG, IV(ALGSAV)
 ...
 110  M = 0
      ...
      DO 140 L = 1, NDFALT
         ...
         IF (VK .GE. VM(I) .AND. VK .LE. VX(I)) GO TO 130
              M = K
              IF (PU .GT. 0) WRITE(PU,120) VN(1,I), VN(2,I), K, VK,
     1                                    VM(I), VX(I)
...
C
 ...
 190  IF (M .EQ. 0) GO TO 200
         ...
         GO TO 999
C
 200  IF (PU .LE. 0 .OR. IV(PARPRT) .EQ. 0) GO TO 999
