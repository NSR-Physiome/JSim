...
C The routine elmhes in decsol.f has been renamed as elmhe2 so as to 
C avoid name conflict with libcm/eispack/elmhes.f  W Chan - Mar 2000
C     IF (CALHES) CALL ELMHES (LDJAC,N,1,N,FJAC,IPHES) 
      IF (CALHES) CALL ELMHE2 (LDJAC,N,1,N,FJAC,IPHES) 
      CALHES=.FALSE.
      DO J=1,N-1
         J1=J+1
         E1(J1,J)=-FJAC(J1,J)
