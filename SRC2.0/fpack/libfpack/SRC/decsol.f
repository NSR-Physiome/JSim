...
c
C
c Changed the following routine from elmhes to elmhe2 so as not to have
c name conflict with elmhes in libcm/eispack. W Chan - Mar 2000
c     subroutine elmhes(nm,n,low,igh,a,int)
      subroutine elmhe2(nm,n,low,igh,a,int)
C
