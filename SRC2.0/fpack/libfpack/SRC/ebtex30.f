      REAL FUNCTION ebt30i(cin, z, q0, deltex, mxseg, rwkv, iwkv, lwkv)
c
c Re-entrant 3-region 2-barrier blood-tissue exchange operator
c
c File ebtex30.f (Version 1.7).  Last modified at 15:28:44 on 08/30/98.
c
c.......................................................................
c
...
c
      DATA         sid1
     + /'@(#)ebtex30.f	1.7 created on 08/30/98 at 15:28:44.'/
      DATA         sid2
...
c-------------------------------------------------------SOLUTION SECTION
c
      ENTRY ebt30(cin, q, time, mxseg, dwkv, rwkv, iwkv, lwkv)
c
...
c
  300 CONTINUE
      ...
      ebt30       = MAX(0.0,(rwkv(IINTO)+oc-rwkv(IOCZER))/rwkv(ISMDT))
c
