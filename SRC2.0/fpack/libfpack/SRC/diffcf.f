...
c When nseg is less than or equal to 5, then the
...
c       ver. 1.3 : Changed test, so there is no longer an alternative
c                  algorithm for diff<=0.25 (MAR2000 - G. Raymond)
c
c ---------------------------------------------------------------------
c
...
c
      DATA         sid1
     + /'@(#)diffcf.f	1.3 created on 03/14/00 at 16:28:17.'/
      DATA         sid2
     + /'@(#) Retrieved on 03/31/00 at 22:20:20.'/
c
