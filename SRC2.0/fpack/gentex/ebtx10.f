      REAL FUNCTION et10i(cin,z,q0,t0,deltex,mxseg, rwkv, iwkv, lwkv)
c
c Re-entrant 1-region 0-barrier blood-tissue exchange operator
c
c File ebtex10.f (Version 1.6).  Last modified at 10:49:56 on 11/16/95.
c
c.......................................................................
c
...
c SYNOPSIS:
c
c     REAL FUNCTION ebt10i(cin, z, q0, t0, deltex, mxseg, rwkv, iwkv, lwkv)
...
c
      DATA         sid1
     + /'@(#)ebtex10.f	1.6 created on 11/16/95 at 10:49:56.'/
      DATA         sid2
     + /'@(#) Retrieved on 3/20/97 at 17:47:33.'/
c
c-------------------------------------------------INITIALIZATION SECTION
c
...
c-------------------------------------------------------SOLUTION SECTION
c
      ENTRY et10(cin, q, time, mxseg, dwkv, rwkv, iwkv, lwkv)
c
...
c
  300 CONTINUE
      ...
      et10  = MAX(0.0, (rwkv(IINTO)+oc-rwkv(IOCZER))/rwkv(ISMDT))
c
