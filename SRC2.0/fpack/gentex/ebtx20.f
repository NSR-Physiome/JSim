      REAL FUNCTION et20i(cin,z,q0,t0,deltex, mxseg, rwkv, iwkv, lwkv)
c
c Re-entrant 2-region 1-barrier blood-tissue exchange operator
c
c File ebtex20.f (Version 1.6).  Last modified at 10:54:50 on 11/16/95.
c
c.......................................................................
c
...
c
      DATA         sid1
     + /'@(#)ebtex20.f	1.6 created on 11/16/95 at 10:54:50.'/
      DATA         sid2
     + /'@(#) Retrieved on 3/20/97 at 17:47:36.'/
c
c-------------------------------------------------INITIALIZATION SECTION
c
...
c-------------------------------------------------------SOLUTION SECTION
c
      ENTRY et20(cin, q, time, mxseg, dwkv, rwkv, iwkv, lwkv)
c
...
c
  300 CONTINUE
      ...
      et20       = MAX(0.0,(rwkv(IINTO)+oc-rwkv(IOCZER))/rwkv(ISMDT))
c
